 ...
 *
 * _Migration from other libraries_: Use [@HeaderParam][HeaderParam] for parameters
 *
 * @see HeaderParam
 * @see HeaderMap
 * @see Header.Companion
 * @see Header.ContentTypes
 * @see Header.AcceptEncodings
...
annotation class Header(
    ...
    object ContentTypes {
        ...
        object MultiPart {
            private const val TYPE = "multipart"
